...
def fetch_mutations(
    ...
    Args:
        ...
        api_url: URL of the CovSpectrum API
        session_prefix: Optional prefix for session state keys to avoid conflicts
    """
    try:
        mutation_data = covSpectrum.fetch_mutations(variant_query, sequence_type, min_abundance, api_url)
...
def render_signature_composer(
    ...
    Args:
        covSpectrum: CovSpectrumLapis instance
        cov_spectrum_api: URL for CovSpectrum API
...
#
# # Render the component in a column
# with col1:
